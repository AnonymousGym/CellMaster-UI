########
# changes made here
input_dir= "uploads/"  #"data/liver/new/"#'uploads/'#"/Users/gaoyiming/Desktop/new_adata_celltypist/"#
h5ad_file = "new_pbmc3k.h5ad"
markers_file = 'markers_pbmc3k.csv'
original_grouping = "leiden"# "seurat_clusters"#
correct_column = "ground_truth"#"cell_ontology_class"#
output_column ="leiden_labels" #"seurat_clusters_labels"#"majority_voting"#"cellmarker"# 
tissue_name = "retina"
threshold = 0.95
file_path = "testbench_result/o1.txt"
########
...
cell_type_mapping = {
    "Monocyte": "Monocyte",
    "iNP": "immature neutrophil",
    "Kupffer": "Kupffer Cell",
    "EC": "Endothelial Cell",
    "imNP": " intermediate mature neutrophil",
    "Pro-erythroblast": "Proerythroblast",
    "Large Pre-B": "Large Pre-B Cell",
    "Small Pre-B": "Small Pre-B Cell",
    "GMP": "Granulocyte-Macrophage Progenitor",
    "HPC": "Hematopoietic Progenitor Cell",
    "B": "B Cell",
    "Hep-neonatal": "Neonatal Hepatocyte",
    "neonatal hepatocyte":"Heptoblast",
    "mNP": "mature neutrophil",
    "T": "T Cell",
    "HSC": "Hematopoietic Stem Cell",
    "Basophil": "Basophil",
    "Dcn+Mac": "Decorin Positive Macrophage",
    ...
    "Hep-D21": "Day 21 Hepatocyte",
    "aDC": "Activated Dendritic Cell",
    "Hep-D56": "Day 56 Hepatocyte",
     "gd T":"Gamma-delta T cells",
     "Treg":"Regulatory T cells",
    "Oligo":"Oligodendrocytes",
    "CD8 T":"cytotoxic T cells",
    "DC2":"Conventional Dendritic Cell Type 2",
    "DC1": "Conventional Dendritic Cell Type 1",
    "Nonclassical monocytes":"monocyte",
    "Alveolar macrophages":"macrophage",
    "migDC":"Dendritic Cells",
    "CD4+ T Helper2": "CD4 T cell",
    "CD4+/CD25 T Reg": "T Regulatory cell",
    "CD4+/CD45RA+/CD25- Naive T": "Naive T cell",
    'CD4+/CD45RO+ Memory':"Memory T cell", 
    'CD8+ Cytotoxic T': "CD8 T cell",
    'CD8+/CD45RA+ Naive Cytotoxic' :"CD8 T cell", 
    'CD14+ Monocyte': "Monocyte", 
    'CD19+ B':"B cells", 
    'CD34+':"HSC",
    'CD56+ NK':"NK cell",
    "epithelial cell of large intestine":"epithelial cell",
    "Brush cell of epithelium proper of large intestine":"brush cell",
    "Endo":"Endo Vascular cell",
    "Erythroid cell":"Erythrocyte",
    "Erythrocyte":"Erythroid",
    "Erythrocytes":"Erythroid",
    "Immature Erythroid cell":"Erythroblast",
    "Immature Erythroblasts":"Erythroblast",
...
print("average score gptcelltype: ",gpt1["agreement_score"].mean())
gpt_score = gpt1["agreement_score"].mean()
print("average score celltypist: ",celltypist1["agreement_score"].mean())
celltypist_score = celltypist1["agreement_score"].mean()
...
print(ours1,gpt1)
ours1.to_csv('testbench_result/ours1.csv', index=False)
gpt1.to_csv('testbench_result/gpt1.csv', index=False)
